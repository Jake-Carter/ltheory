...
local function nebulaComposeUniforms ()
  ...
  Shader.SetFloat('nebulaHeatGlow', Config.gen.nebulaHeatGlow or 0.55)
  Shader.SetFloat('nebulaHeatSaturation', Config.gen.nebulaHeatSaturation or 0.80)
  Shader.SetFloat('nebulaHeatStarBias', Config.gen.nebulaHeatStarBias or 0.45)
  Shader.SetFloat('nebulaHeatHue', Config.gen.nebulaHeatHue or 0.04)
  Shader.SetFloat('nebulaHeatVariation', Config.gen.nebulaHeatVariation or 0.70)
end
